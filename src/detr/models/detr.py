...
from src.detr.models.matcher import build_matcher
from src.detr.models.segmentation import (DETRsegm, PostProcessPanoptic, PostProcessSegm,
...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, device, aux_loss=False):
        ...
        self.bbox_embed = MLP(hidden_dim, hidden_dim, 4, 3).to(self.device)
