...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.setStyleSheet("background-color: rgb(239, 41, 41);")
        ...
        self.tabWidget.setStyleSheet("QTabBar {font: 8pt \"MS Shell Dlg 2\"};")
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.tab)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.uncompressed = QtWidgets.QListWidget(self.tab)
        self.uncompressed.setObjectName("uncompressed")
        self.verticalLayout_8.addWidget(self.uncompressed)
        self.augmented = QtWidgets.QListWidget(self.tab)
